...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Group ID: " + group.getGroupUuid());
        System.out.println("Nested Task Headers: ");
        for (Task<Integer> task : nestedGroup.tasks) {
            System.out.println(task.getHeaders());
        }
    }
}
